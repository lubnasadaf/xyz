...
class DicomAROverlay:
    def __init__(self, dicom_path):
        ...
        self.rotation_angle = 180  # Start with 180-degree rotation (anticlockwise)
    ...
    def rotate_image(self, image, angle):
        ...
        # Get rotation matrix (positive angle = anticlockwise in OpenCV)
    ...
    def run(self):
        ...
        print("  'f'       - Reset rotation to 0°")
        print(f"\nStarting with 180° rotation applied")
        print("="*60 + "\n")
        ...
        while cap.isOpened():
            ...
            if landmarks:
                ...
                if overlay_resized.shape[0] > 0 and overlay_resized.shape[1] > 0:
                    cv2.putText(frame, "Overlay Active", (10, 120), 
